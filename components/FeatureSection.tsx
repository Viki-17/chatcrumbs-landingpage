        ...
        <div className="flex flex-col gap-24">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6">
              ...
              <p className="text-lg text-brand-slate-medium leading-relaxed">
                ChatCrumbs detects related chats across any AI tool and doc app.
                Open the extension and choose what to link.
              </p>
            </div>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-brand-slate-border p-6 relative overflow-hidden group">
                ...
                <div className="absolute top-12 right-6 bg-white rounded-lg shadow-xl border border-brand-blue/20 p-4 w-64 animate-bounce-subtle z-10">
                  <div className="flex justify-between items-start mb-2">
                    <p className="text-sm font-medium text-brand-slate-dark">
                      Link this chat to <br />{" "}
                  ...
                  <div className="flex gap-2 mt-2">
                    <button className="flex-1 bg-brand-blue text-white text-xs py-1.5 rounded hover:bg-blue-700 transition">
                      Link
                    </button>
                    <button className="flex-1 bg-slate-100 text-brand-slate-medium text-xs py-1.5 rounded hover:bg-slate-200 transition">
                      Dismiss
                    </button>
                  </div>
                </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-12">
            <div className="flex-1 space-y-6">
              ...
              <p className="text-lg text-brand-slate-medium leading-relaxed">
                Revisit a document weeks later. The sidebar automatically loads
                every AI conversation linked to that specific project. It works
                where you work, instantly restoring your thought process.
              </p>
            </div>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-brand-slate-border flex h-64 overflow-hidden relative">
                <div className="flex-grow p-6 opacity-40">
                  ...
                  <p className="text-slate-500 text-sm mb-2">
                    The primary focus of Q3 will be on retention...
                  </p>
                  <p className="text-slate-500 text-sm">
                    We utilized the data from the...
                  </p>
                </div>
                <div className="w-48 bg-slate-50 border-l border-brand-slate-border flex flex-col">
                  <div className="p-3 border-b border-brand-slate-border bg-white">
                    <span className="text-xs font-bold text-brand-slate-dark uppercase tracking-wider">
                      Linked Chats
                    </span>
                  </div>
                  <div className="p-2 space-y-2 overflow-y-auto">
                    {[
                      "Claude: Tone Check",
                      "Gemini: Data Sourcing",
                      "GPT-4: Ideas",
                    ].map((item, i) => (
                      <div
                        key={i}
                        className="p-2 bg-white border border-brand-slate-border rounded hover:border-brand-blue cursor-pointer transition shadow-sm group"
                      >
                        <div className="text-xs font-medium text-brand-slate-dark group-hover:text-brand-blue">
                          {item}
                        </div>
                        <div className="text-[10px] text-brand-slate-medium mt-1">
                          2 days ago
                        </div>
                      </div>
                    ))}
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6">
              ...
              <p className="text-lg text-brand-slate-medium leading-relaxed">
                Need to paste the chat link into the doc text itself? Copy
                formatted Markdown or Rich Text hyperlinks with one click. Ideal
                for footnotes or team references.
              </p>
            </div>
                ...
                <div className="relative group cursor-pointer">
                  <div className="flex items-center gap-3 p-4 bg-white border border-brand-slate-border rounded-lg shadow-sm hover:border-brand-blue transition-colors min-w-[240px]">
                    ...
                    <div className="flex-grow">
                      <div className="text-sm font-medium text-brand-slate-dark">
                        Research Thread #4
                      </div>
